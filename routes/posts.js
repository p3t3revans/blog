...
//router.get('/posts', authorization_controller.roleAuthorization(['admin','user','guest']),post_controller.posts_list);
router.get('/posts/page/:page/:size/', post_controller.posts_list);
//router.get('/posts/page/:page/:size/', authorization_controller.roleAuthorization(['admin','user','guest']), post_controller.posts_list);
router.get('/posts/:id', post_controller.post_detail);
router.put('/posts/comment/:id',authorization_controller.roleAuthorization(['admin','user','guest']), post_controller.post_add_comment);
router.post('/posts/create',authorization_controller.roleAuthorization(['admin','user','guest']), post_controller.post_create);
